...
class SavingGoalModel implements FinancialRepresentable {
  final String id;
  final String userId;
  final String name;
  ...
  List<int> get allDaysList {
    ...
    if (method == SavingGoalMethod.custom) {
  ...
  factory SavingGoalModel.fromMap(Map<String, dynamic> map) {
    return SavingGoalModel(
      ...
      contributionDates:
          ...
          {},
      method: SavingGoalMethod.values.firstWhere(
        (e) => e.name == map['method'],
        orElse: () => SavingGoalMethod.defaultPattern,
      ),
  ...
  factory SavingGoalModel.fromJson(String source) =>
      SavingGoalModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
