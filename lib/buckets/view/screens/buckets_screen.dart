...
class BucketsScreen extends StatelessWidget {
  static const String routeName = '/buckets-screen';
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      context.l10n.noSavingsGoalsThisMonth,
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return SavingGoalCard(
                  ...
                  onDelete: () {
                    final bucketsBloc = context.read<BucketsBloc>();
                    ...
                    AppToast.show(
                      ...
                      onCompleted: () {
                        bucketsBloc.add(
                          BucketsEventDeleteGoal(goalId: goal.id),
                        );
                      },
                    );
                  },
