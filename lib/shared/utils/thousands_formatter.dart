...
class ThousandsSeparatorInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (oldValue.text.length > newValue.text.length &&
      ...
      final String textBeforeComma = oldValue.text.substring(
        0,
        oldValue.selection.baseOffset - 1,
      );
      final String textAfterComma = oldValue.text.substring(
      ...
      if (textBeforeComma.isNotEmpty) {
        final newText =
            textBeforeComma.substring(0, textBeforeComma.length - 1) +
            textAfterComma;
    ...
    int cursorPositionInCleaned = newValue.text
